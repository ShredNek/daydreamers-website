...
import { MusicData, Track, ComponentLoadingStatus } from "../types/index";
...
export default function MusicView() {
  ...
  const handleTrackClick = () => {
    ...
    setTimeout(() => navigate(`/music/${songCollectionName}`), FADE_SPEED);
  };
  ...
  useEffect(() => {
    ...
    currTrack
      ? setComponentLoadingState("")
      : setTimeout(() => setComponentLoadingState(""), 5000);
  }, [currTrack]);
